...
class Server():
    ...
    def Accept(self,clientFunc):
        ...
        clnt=ClientHandle(client,addr,self.threads,self.clients,close=self.close)
...
class ClientHandle(ClientHandleInterface):
    
    def __init__(self,sock,addr,threads=[],clients=[],close=[]):
        self.sock=sock
        self.work=True
